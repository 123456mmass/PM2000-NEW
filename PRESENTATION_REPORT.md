...
## 16. ทำไมต้องมีหลายโมเดล AI พร้อมกัน

ระบบนี้รองรับการเรียก AI หลายตัวพร้อมกัน แล้วเลือกคำตอบที่ดีที่สุด

แนวคิดคือ:

- โมเดลหนึ่งอาจตอบเร็ว
- อีกโมเดลหนึ่งอาจตอบละเอียดกว่า
- ระบบจึงลองหลายตัว แล้วเลือกผลที่เหมาะที่สุด
...
- เรียกหลาย AI พร้อมกัน
- ให้ระบบเลือกคำตอบที่คุณภาพดีที่สุด

ประโยชน์:

- เพิ่มโอกาสได้คำตอบที่ดีกว่า
- ลดความเสี่ยงถ้า provider ตัวหนึ่งล่ม
